<?php
/**
 * ReceivedInvoicesResultInvoicesInnerPaymentsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ReceivedInvoicesResultInvoicesInnerPaymentsInner Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\Helios\Invoices
 * @author   OpenAPI Generator team
 ...
 */
class ReceivedInvoicesResultInvoicesInnerPaymentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'receivedInvoicesResult_invoices_inner_payments_inner';
    ...
    */
     ...
     * Sets payment_id
     *
     * @param int|null $payment_id Systémové číslo úhrady [TabUhrady.ID]
     *
     * @return self
     */
     ...
     * Sets payment_date
     *
     * @param \DateTime|null $payment_date Datum úhrady [TabUhrady.Datum]
     *
     * @return self
     */
     ...
     * Sets amount_paid
     *
     * @param float|null $amount_paid Částka úhrady v měně faktury [TabUhrady.Castka]
     *
     * @return self
     */
